  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <header className="sticky top-0 z-20 bg-white/90 backdrop-blur-sm h-16 flex justify-between items-center border-b border-gray-200 px-4 sm:px-6 shadow-sm">
        <h2 className="text-lg sm:text-xl font-semibold text-primary truncate max-w-[70%]">CLJ Registration Hub</h2>
        <SignOutButton />
      </header>
    ...
    <div className="max-w-7xl mx-auto w-full">
      <Authenticated>
        <div className="mb-6">
          ...
          <p className="text-gray-600 text-sm sm:text-base">Manage events and register attendees at the door</p>
        </div>
      ...
      <Unauthenticated>
        <div className="w-full max-w-md mx-auto mt-8 sm:mt-20">
          <div className="text-center mb-8">
            <h1 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-2 sm:mb-4">Event Registration Hub</h1>
            <p className="text-base sm:text-xl text-gray-600">Sign in to manage events and door registration</p>
          </div>
          <SignInForm />
        </div>
      </Unauthenticated>
